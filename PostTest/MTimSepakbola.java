class MTimSepakbola {
  public static void main(String[] args) {
	...
	System.out.println("Pertandingan dimulai" + startTandingBola);
    ...
    for (int i = 0; i < 7; i++) {
  		liverpool.goal();
			...
			System.out.println("Skor sementara: " + liverpool.nama + " " + [getScore.liverpool] + " - " + [getScore.manchesterUnited] + " " + manchesterUnited.nama);
    }
